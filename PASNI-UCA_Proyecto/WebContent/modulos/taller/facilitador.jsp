...
<body class="nav-md">
		                                            ...
		                                            <div class="modal-body">
		                                                ...
		                                                <form class="form-horizontal form-label-left" name="form" method="post" action="../../SLFacilitador?opc=1">
		                                                	<div class="item form-group">
																...
																<br><label>Primer Nombre:</label> 
																<input id="primernombre" name="primernombre" required="required" class="form-control" placeholder="Primer Nombre">
																<br><label>Segundo Nombre:</label> 
																<input id="segundonombre" name="segundonombre" required="required" class="form-control" placeholder="Segundo Nombre">
																<br><label>Primer Apellido:</label> 
																<input id="primerapellido" name="primerapellido" required="required" class="form-control" placeholder="Primer Apellido">
																<br><label>Segundo Apellido:</label> 
																<input id="segundoapellido" name="segundoapellido" required="required" class="form-control" placeholder="Segundo Apellido">
		                                        ...
		                                        <div class="modal-content">
		                                            ...
		                                            <div class="modal-body">
		                                                ...
		                                                <form class="form-horizontal form-label-left" name="form" method="post" action="./SLRol?opc=2">
		                                                	<div class="item form-group">
		                                                		<br><label>Primer Nombre:</label> 
																<input id="primernombreEditar" name="primernombreEditar" required="required" class="form-control" placeholder="Primer Nombre">
																<br><label>Segundo Nombre:</label> 
																<input id="segundonombreEditar" name="segundonombreEditar" required="required" class="form-control" placeholder="Segundo Nombre">
																<br><label>Primer Apellido:</label> 
																<input id="primerapellidoEditar" name="primerapellidoEditar" required="required" class="form-control" placeholder="Primer Apellido">
																<br><label>Segundo Apellido:</label> 
																<input id="segundoapellidoEditar" name="segundoapellidoEditar" required="required" class="form-control" placeholder="Segundo Apellido">
															</div>
															<div class="m-footer">
			                                                	<button type="button" class="btn btn-default" data-dismiss="modal">Cancelar</button>
												...
												%>
                                            		<tr class="even pointer">
                                                		<td class="a-center ">
			                                                ...
			                                                <td class=""><%=f.getPrimerNombre() %></td>
			                                                <td class=""><%=f.getSegundoNombre() %></td>
			                                                <td class=""><%=f.getPrimerApellido() %></td>
			                                                <td class=""><%=f.getSegundoApellido() %></td>
		                                                <td> 
		                                                    <button type="button" id="botonModificar" title="Modificar registro" class="btn btn-success btn-xs" data-toggle="modal" data-target=".modalEditar" onclick="cargarDatos('<%=f.getIdFacilitador() %>', '<%=f.getPrimerNombre() %>', '<%=f.getSegundoNombre()%>', '<%=f.getPrimerApellido() %>', '<%=f.getSegundoApellido() %>')"><i class="fa fa-pencil"></i></button>
		                                                    <button type="button" id="botonEliminar" title="Eliminar registro" class="btn btn-danger btn-xs" data-toggle="modal" data-target="#modalEliminar" onclick="cargarDatos('<%=f.getIdFacilitador() %>', '<%=f.getPrimerNombre() %>', '<%=f.getSegundoNombre()%>', '<%=f.getPrimerApellido() %>', '<%=f.getSegundoApellido() %>')"><i class="fa fa-trash-o"></i></button>
		                                                </td>
		                                            </tr>
    ...
    <script>
    	...
    	function cargarDatos(id, primerNombre, segundoNombre, primerApellido, segundoApellido)
    	{
    		$("#IdFacilitador").val(id);
    		$("#IdFacilitadorEditar").val(id);
    		$("#IdFacilitadorEliminar").val(id);
    		$("#primernombreEditar").val(primerNombre);
    		$("#segundonombreEditar").val(segundoNombre);
    		$("#primerapellidoEditar").val(primerApellido);
    		$("#segundoapellidoEditar").val(segundoApellido);
    	}
