      ...
      <section id="team" class=" blue-bg-service">
        <div class="container">
          ...
          <div class="row">
            ...
            <div class="col-md-4">
              <div class="team text-center">
                <div class="cover" style="background:url('img/tal.jpg'); background-size:cover;">
                  <div class="overlay text-center">
                    <a href="#" data-toggle="modal" data-target="#modal1" class="btn btn-white-fill">Infórmate</a>
                  </div>
                </div>
